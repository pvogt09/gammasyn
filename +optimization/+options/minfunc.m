classdef minfunc < optimization.options.Options
	...
	methods
		function [this] = minfunc(varargin)
			...
			this@optimization.options.Options(optimization.solver.Optimizer.MINFUNC, supportedtype, preferredtype, true, optimization.options.ProblemType.UNCONSTRAINED, optimization.options.ProblemType.UNCONSTRAINED);
			if nargin >= 1
