classdef fmincon < optimization.options.Options
	%FMINCON solver options for fmincon
	...
	methods
		function [this] = fmincon(varargin)
			%FMINCON create new optimization option set
			%	Input:
			...
			this@optimization.options.Options(optimization.solver.Optimizer.FMINCON, supportedtype, preferredtype, true, [
