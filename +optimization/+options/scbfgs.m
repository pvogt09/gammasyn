classdef scbfgs < optimization.options.Options
	...
	methods(Static=true)
		function [this] = fromDCM(value, ~)
			...
			%	Output:
			%		this:	instance
			this = optimization.options.pppbox();
	...
	methods
		function [this] = scbfgs(varargin)
			...
			this@optimization.options.Options(optimization.solver.Optimizer.SCBFGS, supportedtype, preferredtype, true, [
