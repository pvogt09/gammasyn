function [success, fileinfo] = J_mex_fun(overwrite, nobuild)
	%J_MEX_FUN compile objective function for gamma pole placement with 1 output arguments
	%	Input:
	...
	file		= realpath(fullfile(compile.destpath(), '+control', '+design', '+gamma', 'private', 'J_mex_fun'));
	makePfad	= realpath(fullfile(compile.buildpath(), 'J_mex_fun'));
