classdef(Enumeration) GammaSolutionStrategy < Simulink.IntEnumType
	...
	enumeration
		...
		% solve feasibility problem with decoupling conditions first, then solve feasibility problem (if supported) and then solve optimization problem with found solution
		FEASIBILITYITERATION_DECOUPLING(2)
	end
