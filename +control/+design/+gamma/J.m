	...
	if nargout >= 3
		...
		elseif any(options.type == GammaJType.EIGENVALUECONDITION)
			...
			if derivative_feedback
				[eigenvalues, eigenvector_right, eigenvector_left, eigenvalue_derivative, eigenvalue_derivative_xdot, eigenvector_right_derivative, eigenvector_right_derivative_xdot, eigenvector_left_derivative, eigenvector_left_derivative_xdot] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
			...
			if derivative_feedback
				...
				if any(needseigenvalues(:))
					[eigenvalues, ~, ~, eigenvalue_derivative, eigenvalue_derivative_xdot, ~, ~, ~, ~, eigenvalue_2derivative, eigenvalue_2derivative_xdot, eigenvalue_2derivative_m, eigenvalue_2derivative_xdot_m] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
				...
				needseigenvalues = GammaJType_needseigenvalues(options.type);
				if any(needseigenvalues(:))
					[eigenvalues, ~, ~, eigenvalue_derivative, ~, ~, ~, ~, ~, eigenvalue_2derivative] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
	...
	elseif nargout >= 2
		...
		elseif any(options.type == GammaJType.EIGENVALUECONDITION)
			...
			if derivative_feedback
				...
				needseigenvalues = GammaJType_needseigenvalues(options.type);
				if any(needseigenvalues(:))
					[eigenvalues, ~, ~, eigenvalue_derivative, eigenvalue_derivative_xdot] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
				...
				needseigenvalues = GammaJType_needseigenvalues(options.type);
				if any(needseigenvalues(:))
					[eigenvalues, ~, ~, eigenvalue_derivative] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
		...
		if all(options.type == GammaJType.ZERO)
			J = 0;
		elseif any(options.type == GammaJType.EIGENVALUECONDITION)
			[eigenvalues, eigenvector_right, eigenvector_left] = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
			...
			needseigenvalues = GammaJType_needseigenvalues(options.type);
			if any(needseigenvalues(:))
				eigenvalues = calculate_eigenvalues(system, R, K, dimensions, eigenvaluederivativetype, options.usecompiled, numthreads, options.eigenvaluefilter);
