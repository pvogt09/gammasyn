function [pass] = GammasynOptionsTest(~)
	...
	testcases = {
		...
		'tf_structure',					{NaN, 0, zeros(2, 2), NaN(2, 2)},									{-1, 3.4, ones(2, 1), true(2), struct(), {}},																					{'decouplingcontrol'},				false;
		'decouplingstrategy',			{GammaDecouplingStrategy.getDefaultValue()},						{[GammaDecouplingStrategy.getDefaultValue();GammaDecouplingStrategy.getDefaultValue()], -1, ones(2, 1), true, struct(), {}},	{'decouplingcontrol'},				false;
		'sortingstrategy_decoupling',	{GammaDecouplingconditionSortingStrategy.getDefaultValue()},		{repmat(GammaDecouplingconditionSortingStrategy.getDefaultValue(), 2, 1), -1, ones(2, 1), true, struct(), {}},					{'decouplingcontrol'},				false;
		'weight_decoupling',			{1, 0, 2, 1.1, [], true},											{-1, NaN, ones(2, 1), true(2, 1), struct()},																					{'decouplingcontrol'},				false;
		'weight_prefilter',				{1, 0, 2, 1.1, [], true},											{-1, NaN, ones(2, 1), true(2, 1), struct()},																					{'decouplingcontrol'},				false;
		'tolerance_decoupling',			{1, 0, 2, 1.1, NaN, [], true},										{-1, ones(2, 1), true(2, 1), struct()},																							{'decouplingcontrol'},				false;
		'tolerance_prefilter',			{1, 0, 2, 1.1, NaN, [], true},										{-1, ones(2, 1), true(2, 1), struct()},																							{'decouplingcontrol'},				false;
		'solvesymbolic',				{true, false},														{-1, ones(2, 1), true(2, 1), struct(), {}},																						{'decouplingcontrol'},				false;
		'round_equations_to_digits',	{1, 0, 2, NaN, -1, []},												{1.1, ones(2, 1), true, struct()},																								{'decouplingcontrol'},				false;
		'allowoutputdecoupling',		{true, false},														{-1, ones(2, 1), true(2, 1), struct(), {}},																						{'decouplingcontrol'},				false;
