function [pass] = GammasynOptionsTest(~)
	...
	testcases = {
		...
		'eigenvaluefilter',			{GammaEigenvalueFilterType.getDefaultValue()},						{[GammaEigenvalueFilterType.getDefaultValue();GammaEigenvalueFilterType.getDefaultValue()], true, 1, struct()},			{},									false;
		'rho',						{1, 0, -1, NaN},													{ones(2, 1), true, struct(), {}},																					{'objective', 'kreisselmeier'},		false;
		'max',						{1, 0, -1, NaN},													{ones(2, 1), true, struct(), {}},																					{'objective', 'kreisselmeier'},		false;
		'Q',						{1, 0, -1, NaN, ones(2, 2)},										{Inf, true, struct(), 1 + 1j},																								{'objective', 'lyapunov'},			false;
		'R',						{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
		'R_shift',					{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
		'K',						{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
		'K_shift',					{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
		'F',						{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
		'F_shift',					{1, 0, -1},															{NaN, Inf, true, struct()},																							{'objective', 'normgain'},			false;
